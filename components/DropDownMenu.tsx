...
const DropDownMenu = ({ onClose }: DropDownMenuProps) => {
  return (
    <motion.div
      className="w-screen h-screen bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 text-slate-300 p-6 space-y-6 absolute top-28 left-0 right-0 z-50 rounded-t-3xl  "
