  ...
  return (
    <div className=" p-4   mx-auto relative z-10  w-full pt-20 md:pt-32">
      <div
        ...
        bg-clip-text text-transparent bg-gradient-to-b from-[#deb992] to bg-neutral-400 bg-opacity-50"
      >
        The best brands <br /> choose us
      </div>

      <h1 className="mt-4 text-lg font-normal  text-neutral-300 max-w-lg text-center mx-auto">
      ...
      <div className="items-center flex justify-center flex-col text-white">
        ...
        <div className=" text-center">
          <div className="text-sm  font-medium pt-4">Henok</div>
